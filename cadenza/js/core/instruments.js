...
export const INSTRUMENTS = [
  ...
  /* Written an octave above sounding pitch, which the 8vb clef announces. */
  inst({ id: 'tenor_v', name: 'Tenor', abbrev: 'T.', family: 'Voice', program: 52,
    clef: 'treble8vb', transpose: { chromatic: -12, diatonic: -7 }, range: [60, 84], synth: 'voice' }),
  ...
  inst({ id: 'guitar', name: 'Guitar', abbrev: 'Gtr.', family: 'Guitar', program: 24,
    clef: 'treble8vb', transpose: { chromatic: -12, diatonic: -7 }, range: [52, 96], synth: 'pluck' }),
